...
storiesOf('Button', module)
  ...
  .add('Btn burger', () =>
    <Button className="s-btn-icon" onClick={action('clicked')}>
      <img src={btnBurger} alt="button burger 50 x 50" height="50px" width="50px"/>
    </Button>)
  .add('Btn back', () =>
    <Button className="s-btn-icon" onClick={action('clicked')}>
      <img src={btnBack} alt="button back 60 x 60" height="60px" width="60px"/>
    </Button>)
  .add('Btn black share', () =>
    <Button className="s-btn s-black" onClick={action('clicked')}>
      PARTAGER
      <img className="s-icon-symetric" src={btnBack} alt="button share 30 x 30" height="30px" width="30px"/>
    </Button>)
  .add('Btn search', () =>
    <Button className="s-btn-icon" onClick={action('clicked')}>
      <img src={btnSearch} alt="button search 30 x 30" height="30px" width="30px"/>
    </Button>)
  .add('Btn adding', () =>
    <Button className="s-btn-icon" onClick={action('clicked')}>
      <img src={btnAdding} alt="button adding 30 x 30" height="30px" width="30px"/>
    </Button>)
  .add('Btn remove', () =>
    <Button className="s-btn-icon" onClick={action('clicked')}>
      <img src={btnRemove} alt="button remove 30 x 30" height="30px" width="30px"/>
    </Button>)
...
storiesOf('Input', module)
  ...
  .add('Input search', () =>
    <InputLogo className="s-block-input-logo">
      ...
      <Button className="s-btn-icon" onClick={action('clicked')}>
        <img src={btnSearch} alt="button burger 30 x 30" height="30px" width="30px"/>
      </Button>
    </InputLogo>)
...
storiesOf('Page', module)
  .add('Page 1', () =>
    <PageTemplate className="s-bg-orange s-justify-content-center">
      <img className="s-mb-3" src={logoMain} alt="button burger 140 x 140" height="170" width="170"/>
  ...
  .add('Page 2', () =>
    <PageTemplate className="s-bg-orange">
      <img className="s-mt-4" src={logoMain} alt="button burger 140 x 140" height="100" width="100"/>
  ...
  .add('Page 3', () =>
    <PageTemplate className="s-bg-orange">
      <Nav className="s-nav-menu s-nav-noback s-no-title"/>
      <img className="s-mt-1" src={logoMain} alt="logo 100 x 100" height="100" width="100"/>
  ...
  .add('Page 4', () =>
    <PageTemplate className="s-bg-orange">
      ...
      <div className="s-fixed-b">
        ...
        <p><img src={logoMain} alt="logo 100 x 100" height="75" width="75"/></p>
